            ...
            <div class="modal-body">
                <form id="passwordResetForm" method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="text-center">
                        <button type="button" class="btn app-btn-primary" id="reset-password-btn">Enviar enlace de
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        Swal.fire({
                            ...
                            text: 'Enlace de restablecimiento enviado a tu correo electrónico.',
                            icon: 'success',
                            toast: true,
                            position: 'top-end',
                        ...
                        console.log(data
                            .errors); // Muestra los errores en la consola para depuración
                    }
                })
                .catch(error => {
                    Swal.fire({
