    ...
    <div id="submenu-1" class="collapse submenu submenu-1 show" data-bs-parent="#menu-accordion">
        <ul class="submenu-list list-unstyled">
            <li class="submenu-item">
                <a class="submenu-link {{ request()->routeIs('estudiante.pending_exercises') ? 'active' : '' }}" href="{{ route('estudiante.pending_exercises') }}">Pendientes</a>
            </li>
            <li class="submenu-item">
                <a class="submenu-link {{ request()->routeIs('estudiante.sent_graded_exercises') ? 'active' : '' }}" href="{{ route('estudiante.sent_graded_exercises') }}">Enviados/Calificados</a>
            </li>
        </ul>
    </div>
</li>
